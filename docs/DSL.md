...
###<a name="head2"></a>2. Full NGSPipes DSL syntax
...
###<a name="head3"></a>3. Examples

###  <a name="head31"></a> 3.1. A pipeline used on epidemiological surveillance 
...
###  <a name="head32"></a> 3.2. A pipeline used on ChiP-Seq analysis 
